...
export default function Offer({ onGetStartedClick }: OfferProps) {
  return (
...
no questions asked.
        ...
        <button onClick={onGetStartedClick} className="px-12 py-5 bg-white text-blue-600 rounded-xl font-bold text-xl hover:bg-blue-50 transition-all duration-200 shadow-2xl hover:shadow-3xl hover:scale-105 mb-6">
